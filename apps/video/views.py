...
class DetailVideo(APIView):
    def get(self, request, pk):
        ...
        """
        try:
            video = Video.objects.get(pk=pk)  # filtrame por id
    ...
    def put(self,request,pk):
        ...
        try:
            video = Video.objects.get(pk=pk)  # filtrame por id
            video_json = VideoSerializer(video,data=request.data)  #Acá VideoSerializer toma todos los datos que nuestro usr nos envie y los almacena en el objeto video
